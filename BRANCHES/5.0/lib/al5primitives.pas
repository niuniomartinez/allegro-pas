...
(* High level primitives *)
  ...
  PROCEDURE al_calculate_ribbon (dest: PSINGLE; dest_stride: LONGINT; CONST points: ARRAY OF SINGLE; points_stride: LONGINT; thickness: SINGLE; num_segments: LONGINT); CDECL;
  PROCEDURE al_draw_ribbon (CONST points: ARRAY OF SINGLE; points_stride: LONGINT; color: ALLEGRO_COLOR; thickness: SINGLE; num_segments: LONGINT); CDECL;
