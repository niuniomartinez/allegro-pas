...
{$include allegro.cfg}
  ...
  FUNCTION al_color_name_to_rgb (CONST name: STRING; VAR r, g, b: SINGLE): BOOLEAN; CDECL;
  ...
  PROCEDURE al_color_rgb_to_html (r, g, b: SINGLE; str: STRING); CDECL;
  PROCEDURE al_color_html_to_rgb (CONST str: STRING; VAR r, g, b: SINGLE); CDECL;
  ...
  FUNCTION al_color_name (CONST name: STRING): ALLEGRO_COLOR; CDECL;
  FUNCTION al_color_html (CONST str: STRING): ALLEGRO_COLOR; CDECL;
